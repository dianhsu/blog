...
index_img: https://cdn.dianhsu.top/img/2022-06-08-09-05-34.jpeg
---
...
虚线代表实际的速度。
![速度示意图](https://cdn.dianhsu.top/img/2022-06-08-10-32-42.png)
...
![case 1 操作之后的速度情况](https://cdn.dianhsu.top/img/2022-06-08-10-39-03.png)
速度区间仍然还是 $3$ 个，分别是 $(1, 3), (4, 5), (6, 7)$ 。
这个case意味着：**如果将某个位置速度减小之后，此位置速度仍然不小于它所处的区间的速度的值，那么速度区间不会发生合并和拆分。**

另外一个case是 `3 3`，即 $a_3 = a_3 - 3$。
![case 2 操作之后的速度情况](https://cdn.dianhsu.top/img/2022-06-08-10-44-46.png)
